...
public class MvbcNamedQueryConstants {
  ...
  public static final String NAME_FIND_UPLOADED_SERMON_BY_FILENAME = "Series.findUploadedSermonsByFileName";
  public static final String QUERY_FIND_UPLOADED_SERMON_BY_FILENAME = "SELECT s FROM MvbcUploadedSermon s WHERE s.sermonAudioFileName = :sermonAudioFileName ";
